    ...
    <div class="p-4">
        ...
        <div class="pt-4 py-2 flex">
            ...
            <div>
                ...
                <a href="/airbrushes" class="block text-blue-600 underline pt-3">Airbrush Options</a>
            </div>
        </div>
        ...
        <div class="pt-4 py-2 flex">
            ...
            <div>
                ...
                <a href="/airbrushes" class="block text-blue-600 underline pt-3">Paint Options</a>
            </div>
        </div>
        <hr class="h-px my-6 bg-gray-200 border-0 dark:bg-gray-700">
        <div class="pt-4 py-2 flex">
            ...
            <div>
                ...
                <a href="/airbrushes" class="block text-blue-600 underline pt-3">Clear Coat Options</a>
            </div>
        </div>
        <hr class="h-px my-6 bg-gray-200 border-0 dark:bg-gray-700">
        <div class="pt-4 py-2 flex">
            ...
            <div>
                ...
                <a href="/airbrushes" class="block text-blue-600 underline pt-3">Stencil Options</a>
            </div>
        </div>
        <hr class="h-px my-6 bg-gray-200 border-0 dark:bg-gray-700">
        <div class="pt-4 py-2 flex">
            ...
            <div>
                ...
                <a href="/airbrushes" class="block text-blue-600 underline pt-3">Compressor Options</a>
            </div>
        </div>
        <hr class="h-px my-6 bg-gray-200 border-0 dark:bg-gray-700">
        <div>
            ...
            <a href="/airbrushes" class="block text-blue-600 underline pt-3">Accessory Options</a>
        </div>        
